...
//{
//    const int step_up = roi_rect_slice.y < 3*kernel_size_.height ? roi_rect_slice.y : 3 * kernel_size_.height;
//    const int step_down = roi_rect_slice.y + roi_rect_slice.height + 3 * kernel_size_.height > img_initial.cols ? img_initial.cols - roi_rect_slice.y - roi_rect_slice.height : 3 * kernel_size_.height;
